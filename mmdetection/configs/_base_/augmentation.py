...
work_dir = '/opt/ml/detection/mmdetection/work_dirs/mingyu/swin_bright_blur_rgb_cos_crop2'
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='mingyu', entity='carry-van', name='swin_k-fold3_rotate_bright_blur_rgb_cos_crop2'))
    ])
